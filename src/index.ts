...
- **Visual inspection**: figma_screenshot (REST API render or live plugin state)
...
- **Component details**: figma_get_component (format: metadata | reconstruction | development)
- **Styles**: figma_get_styles (color, text, effect, grid styles)
- **Comments**: figma_comments (action: get / post / delete)
