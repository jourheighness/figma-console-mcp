...
<Card title="Full Setup Guide" icon="book-open" href="/setup">
  Detailed instructions for NPX and Local Git installation across all AI clients.
</Card>
...
<Note>
**Open Source** — MIT licensed. Contribute on [GitHub](https://github.com/southleft/figma-console-mcp).
</Note>
