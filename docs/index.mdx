...
<Note>
**New in v1.9.0** — Figma Comments tools: post design-code parity feedback pinned directly to components, retrieve comment threads, and clean up resolved comments. Closes the design-code communication loop without leaving your AI workflow.
</Note>
...
<AccordionGroup>
  <Accordion title="Design System Extraction" icon="palette">
    ...
    - `figma_find_components(verbosity: "overview")` — Overview of entire system
  </Accordion>
...
<Warning>
**Important:** Remote Mode is **read-only** with 21 tools. For design creation, development workflows, variable management, and full capabilities (56+ tools), use NPX Setup.
</Warning>

<Columns cols={2}>
  <Card title="NPX Setup (Recommended)" icon="bolt" href="/setup#-npx-setup-recommended">
    **Full capabilities — 56+ tools**
